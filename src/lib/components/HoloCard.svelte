...
<script lang="ts">
	...
	import { orientation, resetBaseOrientation } from '$lib/stores/orientation'
	import { clamp, round } from '$lib/helpers/math'

	import Glare from '$lib/components/CardGlare.svelte'
	import Shine from '$lib/components/CardShine.svelte'

	export let cardBack = '/card_back.jpg'
